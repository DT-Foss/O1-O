...
from o1o_o.core.executor import Executor
from o1o_o.core.learning import LearningLoop
from o1o_o.core.session_memory import SessionMemory
from o1o_o.core.chat_engine import ChatEngine
from o1o_o.core.project_generator import ProjectGenerator
from o1o_o.core.native_engine import NativeEngine
from o1o_o.core.verifier import Verifier
from o1o_o.core.repository_indexer import RepositoryIndexer
from o1o_o.core.web_harvester import WebHarvester
from o1o_o.core.formal_verifier import FormalVerifier
from o1o_o.core.mathematical_engine import MathematicalEngine
from o1o_o.core.self_improve import SelfImproveLoop
from o1o_o.core.ast_engine import ASTEngine
from o1o_o.core.reverse_forge import ReverseForge
from o1o_o.core.test_generator import TestGenerator
from o1o_o.core.dependency_manager import DependencyManager
from o1o_o.core.dependency_parser import DependencyParser
from o1o_o.core.monte_carlo_ranker import MonteCarloRanker
from o1o_o.core.self_improvement_turbo import SelfImprovementTurbo
from o1o_o.core.taint_analyzer import TaintAnalyzer
...
class ForgeSession:
    ...
    def __init__(self):
        ...
        from o1o_o.core.domain_bootstrapper import DomainBootstrapper
        ...
        from o1o_o.core.symbolic_executor import SymbolicExecutor
        from o1o_o.core.property_verifier import PropertyVerifier
            ...
            try:
                ...
                if user_input.startswith('/harden'):
                    ...
                    if self.memory.current_script:
                        ...
                        from o1o_o.core.security_analyzer import SecurityAnalyzer
                ...
                if user_input.startswith('/cve'):
                    ...
                    from o1o_o.core.cve_fetcher import CVEFetcher, TripletExtractor, format_cve
                    fetcher = CVEFetcher()
                ...
                if user_input.startswith('/synthesize'):
                    ...
                    from o1o_o.core.fragment_synthesizer import FragmentSynthesizer
                    fetcher = CVEFetcher()
                ...
                if user_input.startswith('/crash'):
                    ...
                    from o1o_o.core.crash_analyzer import CrashAnalyzer
                ...
                if user_input.startswith('/decomp'):
                    ...
                    from o1o_o.core.decompiler import DecompPipeline
                ...
                if user_input.startswith('/package'):
                    ...
                    from o1o_o.core.mission_package import MissionPackageBuilder
                ...
                if user_input.startswith('/fuzz'):
                    ...
                    from o1o_o.core.fuzz_generator import FuzzGenerator
                    gen = FuzzGenerator()
                ...
                if user_input.startswith('/decompile'):
                    ...
                    from o1o_o.core.decompiler import Decompiler
                    dec = Decompiler()
                ...
                if user_input.startswith('/evasion'):
                    ...
                    from o1o_o.core.evasion_engine import EvasionEngine
                    ev = EvasionEngine()
                ...
                if user_input.startswith('/ops'):
                    ...
                    from o1o_o.core.operation_replay import OperationReplayEngine
                ...
                if user_input.startswith('/kb'):
                    ...
                    from o1o_o.core.kb_versioning import KBVersioning
                ...
                if user_input.startswith('/intel'):
                    ...
                    from o1o_o.core.cross_intel import CrossIntelEngine
                ...
                if user_input.startswith('/report'):
                    ...
                    from o1o_o.core.vuln_report import VulnReportGenerator, cvss_score
                    import glob
                ...
                if user_input.startswith('/targets'):
                    ...
                    from o1o_o.core.target_queue import TargetQueue, Target
                ...
                if user_input.startswith('/findings'):
                    ...
                    from o1o_o.core.finding_aggregator import FindingAggregator
                ...
                if user_input.startswith('/hunt'):
                    ...
                    from o1o_o.core.hunt_loop import HuntLoop
                ...
                if user_input.startswith('/chain'):
                    ...
                    from o1o_o.core.chain_composer import ChainComposer
                ...
                if user_input.startswith('/autonomous'):
                    ...
                    from o1o_o.core.autonomous_loop import AutonomousLoop
                    loop = AutonomousLoop()
