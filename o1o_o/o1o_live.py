...
from o1o_o.core.payload_delivery import PayloadDeliveryGenerator
            ...
            try:
                ...
                if scan_result.clean:
                    ...
                    if opsec_level in ("full", "standard"):
                        ...
                        try:
                            from o1o_o.core.semantic_evasion import SemanticEvasionEngine
...
def repl(session_mgr):
    ...
    while True:
        ...
        if user_input.lower() in ("/exit", "/quit", "exit", "quit"):
            ...
            _eng_intel = None
            try:
                from o1o_o.core.engage_intelligence import EngageIntelligence
            ...
            try:
                from o1o_o.core.edr_subverter import EDRSubverter
                _edr = EDRSubverter()
            ...
            try:
                from o1o_o.core.canary_detector import CanaryDetector
            ...
            try:
                from o1o_o.core.mitre_coverage import MitreCoverage
                _mc = MitreCoverage(fragments_dir=Path(__file__).resolve().parent / "fragments")
                stats = _mc.get_stats()
        ...
        # ══════════════════════════════════════════════════════════════
            ...
            try:
                from o1o_o.core.operations_db import OperationsDB
                from o1o_o.core.session_restore import SessionRestoreEngine
                _odb = OperationsDB()
            ...
            try:
                if sub == "start":
                    from o1o_o.core.operations_daemon import start_operation
                    ...
                    from o1o_o.core.operations_daemon import stop_operation
            ...
            try:
                from o1o_o.core.payload_mutator import PayloadMutator
                pm = PayloadMutator()
            ...
            try:
                from o1o_o.core.operations_db import OperationsDB
                from o1o_o.core.hash_monitor import HashMonitor
                _odb = OperationsDB()
            ...
            try:
                from o1o_o.core.polyglot_generator import PolyglotGenerator
            ...
            try:
                from o1o_o.core.operations_db import OperationsDB
                from o1o_o.core.credential_trigger_engine import CredentialTriggerEngine
                _odb = OperationsDB()
            ...
            try:
                from o1o_o.core.wifi_exploiter import WiFiExploiter
                wx = WiFiExploiter()
                if sub == "help":
            ...
            try:
                from o1o_o.core.miner_deployer import MinerDeployer
                md = MinerDeployer()
                if not mine_args:
            ...
            try:
                from o1o_o.core.usb_exploiter import USBExploiter
                ux = USBExploiter()
                if sub == "help":
            ...
            try:
                from o1o_o.core.vpn_exploiter import VPNExploiter
                vx = VPNExploiter()
                if sub == "help":
            ...
            try:
                from o1o_o.core.email_exploiter import EmailExploiter
                ex = EmailExploiter()
                if sub == "help":
            ...
            try:
                from o1o_o.core.ml_exploiter import MLModelExploiter
                mx = MLModelExploiter()
                if sub == "help":
            ...
            try:
                from o1o_o.core.operations_tui import OperationsTUI
                from o1o_o.core.operations_db import OperationsDB
                _odb = OperationsDB()
