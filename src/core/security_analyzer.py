...
from core.taint_analyzer import TaintAnalyzer, TaintFinding, SOURCE_PATTERNS, SINK_PATTERNS, SANITIZER_PATTERNS
from core.ast_engine import ASTEngine
from core.vuln_patterns import VulnPatternEngine
