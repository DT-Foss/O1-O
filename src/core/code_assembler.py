...
from core.fragment_registry import FragmentRegistry
from core.color_assembler import ColorAssembler
from core.c_renderer import CRenderer
...
class CodeAssembler:
    ...
    def _wire_variables(self, fragment: str, produced_vars: Dict[str, int],
        ...
        """
        from core.fragment_registry import VARIABLE_COMPATIBILITY
    ...
    def _assemble_color_pipeline(self, intent: Dict[str, Any]) -> Optional[str]:
        ...
        if pipeline:
            ...
            from core.color_types import COLOR_REGISTRY, PATH
